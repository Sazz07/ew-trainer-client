...
const Login = () => {
    ...
    // login with email & password handel
            ...
            <section className="p-6">
                <div className="container grid gap-6 mx-auto lg:grid-cols-2 xl:grid-cols-5">
                    <div className='w-full px-6 rounded-md sm:px-12 md:px-16 xl:col-span-2'>
                        <form onSubmit={handelLogin} className='shadow-lg max-w-[400px] w-full mx-auto rounded-lg bg-gray-200 p-8 px-8'>
                            ...
                            <div className='flex flex-col text-gray-500 py-2'>
                                ...
                                <input className='p-2 rounded-lg bg-rose-200 mt-2 focus:border-blue-500 focus:bg-sky-200 focus:outline-none' type={!check ? "password" : "text"} name='password' placeholder="Your Secret Password" required />
                            </div>
                            ...
                            <button
                                ...
                                aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md hover:bg-gray-300 focus:ring-2 focus:ring-offset-1 border-gray-400 focus:ring-violet-400">
